...
- **222 property setters** — our Customize Form UI tweaks (2026-06-10 onward),
  excluding the 2026-06-09 India Compliance / ERPNext setup burst.
...
bench --site <site> install-app agriops_suite
